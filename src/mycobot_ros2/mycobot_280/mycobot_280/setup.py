...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'rutina = mycobot_280.rutina:main',
            'rutina2 = mycobot_280.rutina2:main',
            'rutina3 = mycobot_280.rutina3:main',
            'origen = mycobot_280.origen:main',
            'aruco_marker = mycobot_280.aruco_marker:main',
            'aruco_marker2 = mycobot_280.aruco_marker2:main',
            'acercamiento = mycobot_280.acercamiento:main',
            "angular_position_server = mycobot_280.angular_position_server:main",
            "barrido_client = mycobot_280.barrido_client_main",
            
            'test_subscription = mycobot_280.test_subscription:main'
        ],
    },
)
