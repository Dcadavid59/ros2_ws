...
#include "mycobot_interfaces/msg/detail/my_aruco_coords__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mycobot_interfaces::msg::MyArucoCoords;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mycobot_interfaces::msg::MyArucoCoords *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mycobot_interfaces::msg::MyArucoCoords *>(
    untyped_ros_message);
...
{
  return &mycobot_interfaces::msg::typesupport_fastrtps_cpp::_MyArucoCoords__handle;
}
