...
static const _MyArucoCoords_type_support_symbol_names_t _MyArucoCoords_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mycobot_interfaces, msg, MyArucoCoords)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mycobot_interfaces, msg, MyArucoCoords)),
  }
};
...
get_message_type_support_handle<mycobot_interfaces::msg::MyArucoCoords>()
{
  return &::mycobot_interfaces::msg::rosidl_typesupport_cpp::MyArucoCoords_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, mycobot_interfaces, msg, MyArucoCoords)() {
  return get_message_type_support_handle<mycobot_interfaces::msg::MyArucoCoords>();
}
