...
bool mycobot_interfaces__msg__my_aruco_coords__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mycobot_interfaces.msg._my_aruco_coords.MyArucoCoords", full_classname_dest, 53) == 0);
  }
  mycobot_interfaces__msg__MyArucoCoords * ros_message = _ros_message;
  {  // x
...
PyObject * mycobot_interfaces__msg__my_aruco_coords__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("mycobot_interfaces.msg._my_aruco_coords");
