...
#include "mycobot_interfaces2/msg/detail/my_aruco_coords__rosidl_typesupport_fastrtps_c.h"
...
#include "mycobot_interfaces2/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _MyArucoCoords__ros_msg_type = mycobot_interfaces2__msg__MyArucoCoords;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mycobot_interfaces2
size_t get_serialized_size_mycobot_interfaces2__msg__MyArucoCoords(
  const void * untyped_ros_message,
...
static uint32_t _MyArucoCoords__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mycobot_interfaces2__msg__MyArucoCoords(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mycobot_interfaces2
size_t max_serialized_size_mycobot_interfaces2__msg__MyArucoCoords(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mycobot_interfaces2__msg__MyArucoCoords;
    is_plain =
      (
...
static size_t _MyArucoCoords__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mycobot_interfaces2__msg__MyArucoCoords(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mycobot_interfaces2, msg, MyArucoCoords)() {
